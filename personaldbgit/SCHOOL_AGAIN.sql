...
, CONSTRAINT FK_TEACHER_FART_DIVISION_NO FOREIGN KEY (TEACHER_DIVISION_NO, TEACHER_FART_DIVISION_NO)
                                         REFERENCES DEPARTMENT_PART_DIVISION_INFO 
                                         (DEPARTMENT_DIVISION_NO, DEPARTMENT_PART_DIVISION_NO)                                      
);
...
INSERT INTO TEACHER_INFO VALUES (SEQ_TEACHER_NO.NEXTVAL, '마선생', '010-7233-1114', 7, DEFAULT, 7500000, 2, 4 );
INSERT INTO TEACHER_INFO VALUES (SEQ_TEACHER_NO.NEXTVAL, '바선생', '010-7233-1115', 6, DEFAULT, 6500000, 2, 3 );
INSERT INTO TEACHER_INFO VALUES (SEQ_TEACHER_NO.NEXTVAL, '사선생', '010-7233-1116', 12, DEFAULT, 12500000, 1, 2 );
...
(
  SP_NO NUMBER CONSTRAINT PK_SP_NO PRIMARY KEY
...
, CONSTRAINT FK_SP_CHILD_NO FOREIGN KEY (SP_CHILD_NO)
                            REFERENCES STUDENT_INFO(STUDENT_NO)
, CONSTRAINT UK_SP_PHONE UNIQUE(SP_PHONE)
);

COMMENT ON COLUMN SCHOOL_PARENT_INFO.SP_NO IS '학부모번호';
...
CREATE TABLE LOGIN
(
  IDENTIFY_NUMBER NUMBER CONSTRAINT PK_IDENTIFY_NUMBER PRIMARY KEY
, TYPE_IDENTIFY_NUMBER NUMBER CONSTRAINT NN_TYPE_IDENTIFY_NUMBER NOT NULL
, ID VARCHAR2(30) CONSTRAINT NN_ID NOT NULL
, PWD VARCHAR2(30) CONSTRAINT NN_PWD NOT NULL
, CONSTRAINT UK_TYPE_IDENTIFY_NUMBER UNIQUE (TYPE_IDENTIFY_NUMBER)
, CONSTRAINT UK_ID UNIQUE (ID)
);
COMMENT ON COLUMN LOGIN.IDENTIFY_NUMBER IS '식별번호';
COMMENT ON COLUMN LOGIN.TYPE_IDENTIFY_NUMBER IS '유형식별번호';
COMMENT ON COLUMN LOGIN.ID IS '아이디';
COMMENT ON COLUMN LOGIN.PWD IS '비밀번호';

CREATE TABLE PARENTS
(
  P_IDENTIFY_NUMBER NUMBER CONSTRAINT PK_P_IDENTIFY_NUMBER PRIMARY KEY
, TYPE_IDENTIFY_NUMBER NUMBER CONSTRAINT NN_P_TYPE_IDENTIFY_NUMBER NOT NULL
, SP_NO NUMBER CONSTRAINT NN_P_SP_NO NOT NULL
, CONSTRAINT FK_P_TYPE_IDENTIFY_NUMBER FOREIGN KEY (TYPE_IDENTIFY_NUMBER)
                                     REFERENCES LOGIN (TYPE_IDENTIFY_NUMBER)
, CONSTRAINT FK_P_SP_NO FOREIGN KEY (SP_NO)
                      REFERENCES SCHOOL_PARENT_INFO(SP_NO)
);

CREATE TABLE TEACHER
(
  T_IDENTIFY_NUMBER NUMBER CONSTRAINT PK_T_IDENTIFY_NUMBER PRIMARY KEY
, TYPE_IDENTIFY_NUMBER NUMBER CONSTRAINT NN_T_TYPE_IDENTIFY_NUMBER NOT NULL
, TEACHER_NO NUMBER CONSTRAINT NN_T_TEACHER_NO NOT NULL
, CONSTRAINT FK_T_TYPE_IDENTIFY_NUMBER FOREIGN KEY (TYPE_IDENTIFY_NUMBER)
                                       REFERENCES LOGIN (TYPE_IDENTIFY_NUMBER)             
, CONSTRAINT FK_T_TEACHER_NO FOREIGN KEY (TEACHER_NO)   
                             REFERENCES TEACHER_INFO (TEACHER_NO)       
);

CREATE TABLE STUDENT
(
  S_IDENTIFY_NUMBER NUMBER CONSTRAINT PK_S_IDENTIFY_NUMBER PRIMARY KEY
, TYPE_IDENTIFY_NUMBER NUMBER CONSTRAINT NN_S_TYPE_IDENTIFY_NUMBER NOT NULL
, STUDENT_NO NUMBER CONSTRAINT NN_S_STUDENT_NO NOT NULL
, CONSTRAINT FK_S_TYPE_IDENTIFY_NUMBER FOREIGN KEY (TYPE_IDENTIFY_NUMBER)
                                       REFERENCES LOGIN (TYPE_IDENTIFY_NUMBER) 
, CONSTRAINT FK_S_STUDENT_NO FOREIGN KEY (STUDENT_NO)
                             REFERENCES STUDENT_INFO (STUDENT_NO)
);
